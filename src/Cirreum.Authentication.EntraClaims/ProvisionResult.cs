...
/// <summary>
/// Represents the outcome of a user provisioning attempt during Entra token issuance.
/// </summary>
/// <remarks>
...
public abstract record ProvisionResult {
	...
	/// <summary>
	/// Blocks token issuance for this user. The login will be rejected by Entra.
	/// </summary>
