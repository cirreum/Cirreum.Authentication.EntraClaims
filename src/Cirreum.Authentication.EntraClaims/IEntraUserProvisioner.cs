...
/// <summary>
/// Provisions and validates a user account during Entra External ID token issuance.
/// </summary>
/// <remarks>
/// <para>
/// Implement this interface to hook into the Entra onTokenIssuanceStart callback and
...
/// Authenticating successfully against Entra does not grant access — your provisioner
/// decides. Common implementations will:
/// </para>
/// <list type="bullet">
...
/// </list>
/// <para>
/// Registration is required. Call <c>services.AddEntraUserProvisioner&lt;TProvisioner&gt;()</c>
/// during app startup. An <see cref="InvalidOperationException"/> will be thrown at startup
/// if no provisioner has been registered.
/// </para>
/// </remarks>
/// <example>
/// <code>
...
///
///         var invitation = await invitations.RedeemAsync(context.EntraUserId, cancellationToken);
///         if (invitation is not null) {
///             await users.CreateAsync(context.EntraUserId, invitation.Role, cancellationToken);
///             return ProvisionResult.Allow(invitation.Role);
///         }
///
///         var existing = await users.FindAsync(context.EntraUserId, cancellationToken);
...
/// </code>
/// </example>
[Obsolete("Use IUserProvisioner from Cirreum.Identity.EntraExternalId instead.")]
