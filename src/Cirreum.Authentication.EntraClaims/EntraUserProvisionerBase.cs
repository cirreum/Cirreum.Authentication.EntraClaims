...
/// <summary>
/// Abstract base implementation of <see cref="IEntraUserProvisioner"/> that handles the
/// standard invitation-redemption pattern used by most Cirreum applications.
/// </summary>
/// <typeparam name="TUser">
/// The application's user entity. Must implement <see cref="IEntraProvisionedUser"/>.
/// </typeparam>
/// <remarks>
/// <para>
...
/// <list type="number">
///   <item><description>
///     <strong>Returning user:</strong> look up the user by Entra object ID →
...
/// </para>
/// <para>
/// Register as scoped so it can access database contexts and other request-scoped services:
/// <c>builder.AddEntraClaims&lt;MyProvisioner&gt;()</c>
/// </para>
/// </remarks>
/// <example>
/// <code>
...
public abstract class EntraUserProvisionerBase<TUser> : IEntraUserProvisioner
	...
	/// <summary>
	/// Looks up an existing user by their Entra object ID.
	/// </summary>
	/// <param name="entraUserId">
	/// The Entra object ID from the token issuance callback. Stored as <c>ExternalId</c>
	/// or <c>EntraUserId</c> on the application's user record.
	/// </param>
	/// <param name="cancellationToken">Cancellation token.</param>
	/// <returns>
	/// The matching user, or <see langword="null"/> if no record exists for this Entra ID.
	/// </returns>
	...
	/// </summary>
	/// <param name="email">
	/// The email address from the Entra token issuance callback.
	/// Implementations should match case-insensitively.
	/// </param>
	/// <param name="entraUserId">
	/// The Entra object ID of the authenticating user. Store this on the new user record
	...
	///   <item><description>Mark the invitation as Claimed (e.g. set <c>ClaimedAt</c>, <c>ClaimedByEntraUserId</c>)</description></item>
	///   <item><description>Create a new user record with <paramref name="entraUserId"/> and the invitation's role</description></item>
	...
	/// data, calling the Graph API to assign the Entra app role, and marking the invitation
	/// as fully Redeemed.
	/// </para>
	/// </remarks>
